#Python Project 24: Simple Attendance Tracker 
import openpyxl 
import smtplib 
...
#staff mail ids 
staff_mails = ['irumghafoor852@gmail.com', 'irumghafoor634@gmail.com']
...
#for students 
def mailstu(li, msg):
    from_id = "programandprogramming01@gmail.com"
    pwd = ""
...
def mailstaff(mail_id, msg):
    from_id = 'irumghafoor852@gmail.com'
    pwd = ""
    to_id = mail_id 
    message = MIMEMultipart()
