#Python Advanced Project 6: Hotel Management System 
#Python program to solve the given question 
#Create a class for hotel data 
...
class User:
    def __init__(self) -> None:
        ...
        self.cost = 0 
    def __repr__(self) -> str:
        return "UserName:{}\t Booking Cost:{}".format(self.uname, self.uId, self.cost)
...
#Functions to solve Hotel Management Problem 
...
if __name__ == '__main__':
    ...
    #Functions to per form operations 
