#Python Project 8: FLAMES GAME
#Flames game is a fun game in which we predict relationship between
#two different individuals based on their names 
...
if __name__ == "__main__":
    ...
    while len(res) > 1:
        ...
        if sidx >= 0:
            ...
            res = res[:len(res) - 1]
    print("Relationship statuse:", res[0])
