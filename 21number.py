#Python Project 4: 21 number game in Python 
#is a simple counting game in which players take turns
#to count numbers from 1 to 21.
#the player who calls "21" loses the game 

#game rules: 
#two players: turns one after another 
#on each turn, a player can call 1 to 3 numbers 
#the numbers must be consecutive (5, 6, 7)
#skip the number, lead to disqualification 
#counting always start from 1 and continue upward 
